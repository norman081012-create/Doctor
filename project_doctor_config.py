...
3. 【Suspected】：**問了症狀有像**，但仍需進一步理學/檢驗/檢查確認。必須嚴格記錄為 `suspected [診斷] need further [處置]`。
4. 【R/O (Rule Out)】：**問了症狀不像**，但考量嚴重性或風險，還必須做理學/檢驗/檢查來排除的診斷。必須嚴格記錄為 `r/o [診斷] need further [處置]`。
</soap_a>
<soap_p>
