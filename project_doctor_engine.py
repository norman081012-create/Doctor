# ==========================================
# project_doctor_engine.py (v2.3 完整支援四階段問診版)
# ==========================================
import re
...
def extract_doctor_dashboard(clinical_text):
    """
    從引擎的內部推演區塊提取核心標籤。
    v2.3 新增捕捉 <current_phase> 與 <opqrst_status> 狀態，方便前端即時監控問診階段。
    """
...
def parse_chat_response(full_text):
    ...
    """
    # 移除可能的 markdown 程式碼區塊標記 (例如 ```xml 或 ```)
...
# 保留原本的單向推演相容性（如果後續還有單純生成分析報告的需求）
